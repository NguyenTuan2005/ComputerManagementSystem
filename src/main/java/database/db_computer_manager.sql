...
CREATE TABLE customer (
                          ...
                          avata_img VARCHAR,
                          number_of_purchased INT DEFAULT '0',
                          block int CHECK (block = 1 OR block = 0)
);

ALTER TABLE customer ADD CONSTRAINT customer_email_unique UNIQUE(email);

ALTER TABLE customer ALTER COLUMN block SET DEFAULT '0';
...
ALTER TABLE account ALTER COLUMN block SET DEFAULT 0;
