...
-- update
ALTER TABLE suppliers ADD COLUMN delete_row INT DEFAULT '1';

ALTER TABLE suppliers RENAME COLUMN contact_date TO contract_date;

ALTER TABLE "order" RENAME COLUMN orderdata TO order_date;
