  ...
  public static void main(String[] args) {
    ...
    Customer c1 =
        Customer.builder()
            ...
            .address("123 Main St")
            .password("123")
            .createdAt(LocalDate.of(2000, 2, 2))
    ...
    //        Customer c1 = new Customer(1,"nguyen huu
    // A","asdas@ACm","nlu","1232",LocalDate.of(12,2,2),"ul","dfasf",LocalDate.of(231,12,2),true);
    //        Customer c2 = new Customer(1,"nguyen huu
    // B","asdas@ACm","nlu","1232",LocalDate.of(12,2,2),"ul","dfasf",LocalDate.of(231,12,2),true);
    //        Customer c3 = new Customer(1,"nguyen huu
    // duy","asdas@ACm","nlu","1232",LocalDate.of(12,2,2),"ul","dfasf",LocalDate.of(231,12,2),true);
    //        Customer c4 = new Customer(1,"nguyen huu
    // m","asdas@ACm","nlu","1232",LocalDate.of(12,2,2),"ul","dfasf",LocalDate.of(231,12,2),true);
    //        System.out.println( new Customer(1,"nguyen huu
    // A","asdas@ACm","nlu","1232",LocalDate.of(12,2,2),"ul","dfasf",LocalDate.of(231,12,2),true));
    ...
    Order order1 =
        new Order(1, c2, "456 Another St", LocalDate.now(), "Pending", orderDetailsByDuy);
    Order order2 =
        new Order(1, c3, "456 Another St", LocalDate.now(), "Pending", orderDetailsByDuy);
    Order order3 =
        new Order(1, c1, "456 Another St", LocalDate.now(), "Pending", orderDetailsByDuy);
