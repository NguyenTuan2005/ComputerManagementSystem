...
public class Product {
  ...
  public boolean equals(Object o) {
    ...
    return id == product.id
        ...
        && Float.compare(weight, product.weight) == 0
        ...
        && Objects.equals(memory, product.memory)
        && Objects.equals(ram, product.ram)
        && Objects.equals(madeIn, product.madeIn)
        && Objects.equals(disk, product.disk)
        && Objects.equals(monitor, product.monitor)
        && Objects.equals(card, product.card)
