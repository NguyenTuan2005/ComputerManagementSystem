...
public class CustomerMenuPanel extends JPanel {
  ...
  CustomButton productCatalogBt, orderHistoryBt, notificationBt, changeInfoBt, logoutBt;
  ...
  class ComponentTop extends JPanel {
    public ComponentTop() {
      ...
      role = LabelConfig.createLabel("Customer",Style.FONT_PLAIN_15, Color.GRAY,SwingConstants.LEFT);
  ...
  class ComponentButton extends JPanel {
    public ComponentButton() {
      ...
      productCatalogBt =
              ButtonConfig.createCustomButton(" Product Catalog",Style.FONT_PLAIN_18,Color.BLACK,
      ...
      orderHistoryBt = ButtonConfig.createCustomButton(" Order History",Style.FONT_PLAIN_18,Color.BLACK,
              Style.MENU_BACKGROUND_COLOR,Style.LIGHT_BlUE,20,SwingConstants.LEFT,new Dimension(180,25));
      ...
      changeInfoBt = ButtonConfig.createCustomButton(" Change Information",Style.FONT_PLAIN_18,Color.BLACK,
              Style.MENU_BACKGROUND_COLOR,Style.LIGHT_BlUE,20,SwingConstants.LEFT,new Dimension(180,25));
