      ...
      resendCodeBt.addActionListener(
          new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
              ...
              //                    InputFormPanel.sendOTPForRegister("",
              // SignUpFormPanel.otpRegister);
              //                        inputFormPanel.signUpPanel.showPanelSignUp("verifyEmail");
              ...
              if (newPassword.equals(confirmPassword)) {
                ...
                Customer newCustomer =
                    new Customer(
                        ...
                        email,
                        address,
                        new PasswordSecurity(newPassword).generatePassword(),
                        "src/main/java/img/default-avt.png");
          ...
          new FocusListener() {
            ...
            public void focusGained(FocusEvent e) {
              if (nameField.getText().equals("User Email")
                  || nameField.getText().equals("User Name")) {
                nameField.setText("");
                  ...
                  case CUSTOMER_ROLE:
                    {
                      ...
                      } else sayError(CustomerController.loginStatus.getMessager());
                      break;
                    }
                }
              }
