...
public class ManagerMenuPanel extends JPanel {
  ...
  class ComponentButton extends JPanel {
    public ComponentButton() {
      ...
      supplierBt =
          createButton("SUPPLIER", Style.FONT_BOLD_15, Color.white, Style.BACKGROUND_COLOR);
      setIcon("src/main/java/Icon/supplierIcon.png", supplierBt);
      add(supplierBt);

      customerBt =
          createButton("CUSTOMER", Style.FONT_BOLD_15, Color.white, Style.BACKGROUND_COLOR);
      ...
      inventoryBt =
          createButton("INVENTORY", Style.FONT_BOLD_15, Color.white, Style.BACKGROUND_COLOR);

      setIcon("src/main/java/Icon/inventoryIcon.png", inventoryBt);
      add(inventoryBt);

      accountManagementBt =
          createButton("ACCOUNT", Style.FONT_BOLD_15, Color.white, Style.BACKGROUND_COLOR);
      setIcon("src/main/java/Icon/user_15094854.png", accountManagementBt);
      add(accountManagementBt);

      notificationBt =
          createButton("NOTIFICATION", Style.FONT_BOLD_15, Color.white, Style.BACKGROUND_COLOR);
  ...
  class ComponentBottom extends JPanel {
    public ComponentBottom() {
      ...
      changeInformBt =
          createButton(
              "CHANGE INFORMATION", Style.FONT_BOLD_15, Color.white, Style.BACKGROUND_COLOR);
      setIcon("src/main/java/Icon/iconChangeInform.png", changeInformBt);
      add(changeInformBt);

      switchToLoginBt =
          createButton("SWITCH TO LOGIN", Style.FONT_BOLD_15, Color.white, Style.BACKGROUND_COLOR);
      setIcon("src/main/java/Icon/switchRole_Icon.png", switchToLoginBt);
      add(switchToLoginBt);

      logoutBt =
          createButton(
              "LOGOUT", Style.FONT_BOLD_15, Style.CANCEL_BUTTON_COLOR_RED, Style.BACKGROUND_COLOR);
