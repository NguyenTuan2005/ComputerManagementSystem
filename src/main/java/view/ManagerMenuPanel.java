...
public class ManagerMenuPanel extends JPanel {
  ...
  class ComponentTop extends JPanel {
    public ComponentTop() {
      ...
      name = LabelConfig.createLabel("<html>" + CurrentUser.USER_NAME + "<html>",Style.FONT_BOLD_20, Color.BLACK,SwingConstants.CENTER);
      name.setPreferredSize(new Dimension(230,50));
      name.setAlignmentX(Component.CENTER_ALIGNMENT);


      role = LabelConfig.createLabel("Manager",Style.FONT_PLAIN_15, Color.GRAY,SwingConstants.LEFT);
  ...
  class ComponentButton extends JPanel {
    public ComponentButton() {
      ...
      productBt = ButtonConfig.createCustomButton(" Product",Style.FONT_PLAIN_18,Color.BLACK,
      ...
      supplierBt = ButtonConfig.createCustomButton(" Supplier",Style.FONT_PLAIN_18,Color.BLACK,
              Style.MENU_BACKGROUND_COLOR,Style.LIGHT_BlUE,20,SwingConstants.LEFT,new Dimension(180,25));
      ButtonConfig.setButtonIcon("src/main/java/Icon/supplierIcon.png",supplierBt,5);
      add(supplierBt);

      customerBt =ButtonConfig.createCustomButton(" Customer",Style.FONT_PLAIN_18,Color.BLACK,
              Style.MENU_BACKGROUND_COLOR,Style.LIGHT_BlUE,20,SwingConstants.LEFT,new Dimension(180,25));
      ButtonConfig.setButtonIcon("src/main/java/Icon/catalog_Icon.png",customerBt,5);
      add(customerBt);

      orderBt = ButtonConfig.createCustomButton(" Order",Style.FONT_PLAIN_18,Color.BLACK,
              Style.MENU_BACKGROUND_COLOR,Style.LIGHT_BlUE,20,SwingConstants.LEFT,new Dimension(180,25));
      ButtonConfig.setButtonIcon("src/main/java/Icon/orderIcon.png",orderBt,5);
      add(orderBt);

      inventoryBt = ButtonConfig.createCustomButton(" Inventory",Style.FONT_PLAIN_18,Color.BLACK,
              Style.MENU_BACKGROUND_COLOR,Style.LIGHT_BlUE,20,SwingConstants.LEFT,new Dimension(180,25));
      ButtonConfig.setButtonIcon("src/main/java/Icon/inventoryIcon.png",inventoryBt,5);
      add(inventoryBt);

      accountManagementBt = ButtonConfig.createCustomButton(" Account",Style.FONT_PLAIN_18,Color.BLACK,
              Style.MENU_BACKGROUND_COLOR,Style.LIGHT_BlUE,20,SwingConstants.LEFT,new Dimension(180,25));
      ButtonConfig.setButtonIcon("src/main/java/Icon/user_15094854.png",accountManagementBt,5);

      add(accountManagementBt);

      notificationBt = ButtonConfig.createCustomButton(" Notification",Style.FONT_PLAIN_18,Color.BLACK,
              Style.MENU_BACKGROUND_COLOR,Style.LIGHT_BlUE,20,SwingConstants.LEFT,new Dimension(180,25));
      ButtonConfig.setButtonIcon("src/main/java/Icon/iconNotification.png",notificationBt,5);
      add(notificationBt);

      changeInformBt = ButtonConfig.createCustomButton(" Change Information",Style.FONT_PLAIN_18,Color.BLACK,
              Style.MENU_BACKGROUND_COLOR,Style.LIGHT_BlUE,20,SwingConstants.LEFT,new Dimension(180,25));
  ...
  class ComponentBottom extends JPanel {
    public ComponentBottom() {
      ...
      switchToLoginBt = ButtonConfig.createCustomButton(" Switch to Login",Style.FONT_PLAIN_18,Color.BLACK,
              Style.MENU_BACKGROUND_COLOR,Style.LIGHT_BlUE,20,SwingConstants.LEFT,new Dimension(180,20));
      ...
      logoutBt = ButtonConfig.createCustomButton(" Logout",Style.FONT_PLAIN_18,Style.CANCEL_BUTTON_COLOR_RED,
              Style.MENU_BACKGROUND_COLOR,Style.LIGHT_RED,20,SwingConstants.LEFT,new Dimension(180,20));
