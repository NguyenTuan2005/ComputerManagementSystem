...
public class ChangePasswordFrame extends JFrame {
    ...
    private void createButtonPanel() {
        ...
        ButtonConfig.addButtonHoverEffect(confirmButton, ButtonConfig.BUTTON_HOVER_COLOR, ButtonConfig.BUTTON_COLOR);
    ...
    private boolean validateInputFields(String oldPassword, String newPassword, String confirmPassword) {
